...
The `Solid.value` factory is useful for passing and `providers` to modals, because they are spawned in a new tree.
  ...
  return showDialog(
    ...
    builder: (dialogContext) {
      ...
      return Solid.value(
        ...
        providerTypesOrIds: const [_SignalId.counter, _SignalId.doubleCounter],
        child: Builder(
