...
- `whem` forces you to handle all the states of a Resource
- `maybeWhen` lets you decide which states to handle and provide an `orElse` action for unhandled states
